...
class KeyBoard:
  def __init__(self,master):
    ...
    self.button1=tk.Button(frame1,text=u'\u09E7',width=2,bg='white',activebackground='white',command=self.key_button1)
    self.button1.grid(row=0,column=1,padx=1,pady=1)
    
    self.button2=tk.Button(frame1,text=u'\u09E8',width=2,bg='white',command=self.key_button2)
    self.button2.grid(row=0,column=2,padx=1,pady=1)
    
    self.button3=tk.Button(frame1,text=u'\u09E9',width=2,bg='white',command=self.key_button3)
    self.button3.grid(row=0,column=3,padx=1,pady=1)
    
    self.button4=tk.Button(frame1,text=u'\u09EA',width=2,bg='white',command=self.key_button4)
    self.button4.grid(row=0,column=4,padx=1,pady=1)
    
    self.button5=tk.Button(frame1,text=u'\u09EB',width=2,bg='white',command=self.key_button5)
    self.button5.grid(row=0,column=5,padx=1,pady=1)

    self.button6=tk.Button(frame1,text=u'\u09EC',width=2,bg='white',command=self.key_button6)
    self.button6.grid(row=0,column=6,padx=1,pady=1)
    
    self.button7=tk.Button(frame1,text=u'\u09ED',width=2,bg='white',command=self.key_button7)
    self.button7.grid(row=0,column=7,padx=1,pady=1)
    
    self.button8=tk.Button(frame1,text=u'\u09EE',width=2,bg='white',command=self.key_button8)
    self.button8.grid(row=0,column=8,padx=1,pady=1)
    
    self.button9=tk.Button(frame1,text=u'\u09EF',width=2,bg='white',fg='blue',command=self.key_button9)
    self.button9.grid(row=0,column=9,padx=1,pady=1)
    
    self.button10=tk.Button(frame1,text=u'\u09E6',width=2,bg='white',command=self.key_button10)
    ...
    self.button12=tk.Button(frame1,text=u'\u09C3',width=2,bg='white',command=self.key_button12)
...
#********************ROW-2********************************#
    ...
    self.r1_button2=tk.Button(frame1,text=u'\u09CC',width=2,bg='white',command=self.key_r2_button2)
    self.r1_button2.grid(row=1,column=2,sticky='W',padx=1,pady=1)
    
    self.r1_button3=tk.Button(frame1,text=u'\u09C8',width=2,bg='white',command=self.key_r2_button3)
    self.r1_button3.grid(row=1,column=3,sticky='W',padx=1,pady=1)
    
    self.r1_button4=tk.Button(frame1,text=u'\u09BE',width=2,bg='white',command=self.key_r2_button4)
    self.r1_button4.grid(row=1,column=4,sticky='W',padx=1,pady=1)
    
    self.r1_button5=tk.Button(frame1,text=u'\u09C0',width=2,bg='white',command=self.key_r2_button5)
    self.r1_button5.grid(row=1,column=5,padx=1,sticky='W',pady=1)
    
    self.r1_button6=tk.Button(frame1,text=u'\u09C2',width=2,bg='white',command=self.key_r2_button6)
    self.r1_button6.grid(row=1,column=6,padx=1,stick='W',pady=1)
    
    self.r1_button7=tk.Button(frame1,text=u'\u09AC',width=2,bg='white',command=self.key_r2_button7)
    self.r1_button7.grid(row=1,column=7,padx=1,sticky='W',pady=1)
    
    self.r1_button8=tk.Button(frame1,text=u'\u09B9',width=2,bg='white',command=self.key_r2_button8)
    self.r1_button8.grid(row=1,column=8,padx=1,sticky='W',pady=1)
    
    self.r1_button9=tk.Button(frame1,text=u'\u0997',width=2,bg='white',command=self.key_r2_button9)
    self.r1_button9.grid(row=1,column=9,padx=1,sticky='W',pady=1)
    
    self.r1_button10=tk.Button(frame1,text=u'\u09A6',width=2,bg='white',command=self.key_r2_button10)
    self.r1_button10.grid(row=1,column=10,padx=1,sticky='W',pady=1)
    
    self.r1_button11=tk.Button(frame1,text=u'\u099C',width=2,bg='white',command=self.key_r2_button11)
    self.r1_button11.grid(row=1,column=11,padx=1,sticky='W',pady=1)
    
    self.r1_button12=tk.Button(frame1,text=u'\u09A1',width=2,bg='white',command=self.key_r2_button12)
...
#********************ROW-3**********************************#
    ...
    self.r2_button2=tk.Button(frame1,text=u'\u0986',width=2,bg='white')
    self.r2_button2.grid(row=2,column=2,padx=1,pady=1,sticky='W')
    
    self.r2_button3=tk.Button(frame1,text=u'\u09CB',width=2,bg='white',command=self.key_r4_button3)
    self.r2_button3.grid(row=2,column=3,padx=1,pady=1,sticky='W')
    
    self.r2_button4=tk.Button(frame1,text=u'\u09C7',width=2,bg='white',command=self.key_r4_button4)
    self.r2_button4.grid(row=2,column=4,padx=1,pady=1,sticky='W')

    self.r2_button5=tk.Button(frame1,text=u'\u09CD',width=2,bg='white',command=self.key_r4_button5)
    self.r2_button5.grid(row=2,column=5,padx=1,pady=1,sticky='W')  

    self.r2_button6=tk.Button(frame1,text=u'\u09BF',width=2,bg='white',command=self.key_r4_button6)
    self.r2_button6.grid(row=2,column=6,padx=1,pady=1,sticky='W')
    
    self.r2_button7=tk.Button(frame1,text=u'\u09C1',width=2,bg='white',command=self.key_r4_button7)
    self.r2_button7.grid(row=2,column=7,padx=1,pady=1,sticky='W')
    
    self.r2_button8=tk.Button(frame1,text=u'\u09AA',width=2,bg='white',command=self.key_r4_button8)
    self.r2_button8.grid(row=2,column=8,padx=1,pady=1,sticky='W')
    
    self.r2_button9=tk.Button(frame1,text=u'\u09B0',width=2,bg='white',command=self.key_r4_button9)
    self.r2_button9.grid(row=2,column=9,padx=1,pady=1,sticky='W')
    
    self.r2_button10=tk.Button(frame1,text=u'\u0995',width=2,bg='white',activebackground='green',command=self.key_r4_button10)
    self.r2_button10.grid(row=2,column=10,padx=1,pady=1,sticky='W')
    
    self.r2_button11=tk.Button(frame1,text=u'\u09A4',width=2,bg='white',command=self.key_r4_button11)
    self.r2_button11.grid(row=2,column=11,padx=1,pady=1,sticky='W')
    
    self.r2_button12=tk.Button(frame1,text=u'\u099A',width=2,bg='white',command=self.key_r4_button12)
    self.r2_button12.grid(row=2,column=12,padx=1,pady=1,sticky='W')
    
    self.r2_button13=tk.Button(frame1,text=u'\u099F',width=2,bg='white',command=self.key_r4_button13)
...
#*****************************ROW-4**************************************#
    ...
    self.r3_button2=tk.Button(frame1,text=u'\u09CE',width=2,bg='white',command=self.key_r5_button1)
    self.r3_button2.grid(row=3,column=2,padx=1,pady=1,sticky='W')
    
    self.r3_button3=tk.Button(frame1,text=u'\u0982',width=2,bg='white',command=self.key_r5_button2)
    self.r3_button3.grid(row=3,column=3,padx=1,pady=1,sticky='W')
    
    self.r3_button4=tk.Button(frame1,text=u'\u09AE',width=2,bg='white',command=self.key_r5_button3)
    self.r3_button4.grid(row=3,column=4,padx=1,pady=1,sticky='W')
    
    self.r3_button5=tk.Button(frame1,text=u'\u09A8',width=2,bg='white',command=self.key_r5_button4)
    self.r3_button5.grid(row=3,column=5,padx=1,pady=1,sticky='W')
    
    self.r3_button6=tk.Button(frame1,text=u'\u09AC',width=2,bg='white',command=self.key_r5_button5)
    self.r3_button6.grid(row=3,column=6,padx=1,pady=1,sticky='W')
    
    self.r3_button7=tk.Button(frame1,text=u'\u09B2',width=2,bg='white',command=self.key_r5_button6)
    self.r3_button7.grid(row=3,column=7,padx=1,pady=1,sticky='W')
    
    self.r3_button8=tk.Button(frame1,text=u'\u09B8',width=2,bg='white',command=self.key_r5_button7)
    self.r3_button8.grid(row=3,column=8,padx=1,pady=1,sticky='W')
    
    self.r3_button9=tk.Button(frame1,text=u'\u0986',width=2,anchor=tk.NE,bg='white',command=self.key_r5_button8)
    self.r3_button9.grid(row=3,column=9,padx=1,pady=1,sticky='W')
    
    self.r3_button10=tk.Button(frame1,text=u'\u0986',width=2,anchor=tk.NE,bg='white',command=self.key_r5_button9)
    self.r3_button10.grid(row=3,column=10,padx=1,pady=1,sticky='W')
    
    self.r3_button11=tk.Button(frame1,text=u'\u09DF',width=2,bg='white',command=self.key_r5_button10)
...
#******************************ROW-5*********************************************#
  ...
  def key_button1(self):
    Wordnet.search.insert('end',u'\u09E7')
  def key_button2(self):
    Wordnet.search.insert('end',u'\u09E8')
  def key_button3(self):
    Wordnet.search.insert('end',u'\u09E9')
  def key_button4(self):
    Wordnet.search.insert('end',u'\u09EA')
  def key_button5(self):
    Wordnet.search.insert('end',u'\u09EB')
  def key_button6(self):
    Wordnet.search.insert('end',u'\u09EC')
  def key_button7(self):
    Wordnet.search.insert('end',u'\u09ED')
  def key_button8(self):
    Wordnet.search.insert('end',u'\u09EE')
  def key_button9(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09EF')
    else:
      Wordnet.search.insert('end','(')
  def key_button10(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09E6')
    else:
      Wordnet.search.insert('end',')')
  def key_button11(self):
    if self.i==0:
      ...
      Wordnet.search.insert('end',u'\u0983')
  def key_button12(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09C3')
    else:
      Wordnet.search.insert('end',u'\u098B')
...
#****************************************ROW-1******************************************************************#
  ...
  def key_r2_button2(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09CC')
    else:
      Wordnet.search.insert('end',u'\u0994')
  def key_r2_button3(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09C8')
    else:
      Wordnet.search.insert('end',u'\u0990')
  def key_r2_button4(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09BE')
    else:
      Wordnet.search.insert('end',u'\u09A6')
  def key_r2_button5(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09C0')
    else:
      Wordnet.search.insert('end',u'\u0988')
  def key_r2_button6(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09C2')
    else:
      Wordnet.search.insert('end',u'\u09BA')
  def key_r2_button7(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09AC')
    else:
      Wordnet.search.insert('end',u'\u09AD')
  def key_r2_button8(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09B9')
    else:
      Wordnet.search.insert('end',u'\u0999')
  def key_r2_button9(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u0997')
    else:
      Wordnet.search.insert('end',u'\u0998')
  def key_r2_button10(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09A6')
    else:
      Wordnet.search.insert('end',u'\u09A7')
  def key_r2_button11(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u099C')
    else:
      Wordnet.search.insert('end',u'\u09AC')
  def key_r2_button12(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09A1')
    else:
      Wordnet.search.insert('end',u'\u09A2')
  def key_r2_button13(self):
    if self.i==0:
      Wordnet.search.insert('end','')
    else:
      Wordnet.search.insert('end',u'\u099E')
 
 #********************************************ROW-3*************************************************************#
 
  def key_r4_button3(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09CB')
    else:
      Wordnet.search.insert('end',u'\u0993')
  def key_r4_button4(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09C7')
    else:
      Wordnet.search.insert('end',u'\u098F')
  def key_r4_button5(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09CD')
    else:
      Wordnet.search.insert('end',u'\u0985')
  def key_r4_button6(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09BF')
    else:
      Wordnet.search.insert('end',u'\u0987')
  def key_r4_button7(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09C1')
    else:
      Wordnet.search.insert('end',u'\u0989')
  def key_r4_button8(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09AA')
    else:
      Wordnet.search.insert('end',u'\u09AB')
  def key_r4_button9(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09B0')
    else:
      Wordnet.search.insert('end',u'\u09DD')
  def key_r4_button10(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u0995')
    else:
      Wordnet.search.insert('end',u'\u0996')
  def key_r4_button11(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09A4')
    else:
      Wordnet.search.insert('end',u'\u09A5')
  def key_r4_button12(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u099A')
    else:
      Wordnet.search.insert('end',u'\u099B')
  def key_r4_button13(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09FF')
    else:
      Wordnet.search.insert('end',u'\u09A0')
     
  #*****************************************ROW-4****************************************************#
   
  def key_r5_button1(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09CE')
    else:
      Wordnet.search.insert('end','?')
  def key_r5_button2(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u0982')
    else:
      Wordnet.search.insert('end',u'\u09FA')
  def key_r5_button3(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09AE')
    else:
      Wordnet.search.insert('end',u'\u09A3')
  def key_r5_button4(self):
    Wordnet.search.insert('end',u'\u09A8')
  def key_r5_button5(self):
    Wordnet.search.insert('end',u'\u09AC')
  def key_r5_button6(self):
    Wordnet.search.insert('end',u'\u09B2')
  ...
  def key_r5_button7(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09B8')
    else:
      Wordnet.search.insert('end',u'\u09B6')
  def key_r5_button8(self):
    if self.i==0:
      Wordnet.search.insert('end',',')
    else:
      Wordnet.search.insert('end',u'\u09B7')
  ...
  def key_r5_button10(self):
    if self.i==0:
      Wordnet.search.insert('end',u'\u09DF')
    else:
      Wordnet.search.insert('end',u'\u09AF')
